...
#
# $Id: hosts.cgi 3148 2009-06-28 16:02:28Z owes $
#
# Franck
...
# Files used
my $settingsfilename = '/var/ipcop/main/settings';
our $datafile = '/var/ipcop/main/hosts';    #(our: used in subroutine)
...
<tr>
    ...
    <td class='button1button'><input type='hidden' name='ACTION' value='$Lang::tr{'add'}' /><input type='submit' name='SUBMIT' value='$buttontext' /></td>
    <td class='onlinehelp'>
