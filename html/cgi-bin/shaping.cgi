...
#
# $Id: shaping.cgi 5147 2010-11-19 18:18:28Z owes $
#

# Add entry in menu
# MENUENTRY services 060 "traffic shaping" "traffic shaping settings"
...
my %shapingsettings = ();
my $configfile      = '/var/ipcop/shaping/config';
my $settingsfile    = '/var/ipcop/shaping/settings';
my $errormessage    = '';
my $error_settings  = '';
my $error_config    = '';
